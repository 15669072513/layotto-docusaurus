...
The component needs to be configured before use. For detailed configuration items, see [State Component Document](i18n/en/docusaurus-plugin-content-docs/current/component_specs/state/common.md)

### Example
Layotto client sdk encapsulates the logic of grpc call. For examples of using sdk to call State API, please refer to [Quick Start: Use State API](i18n/en/docusaurus-plugin-content-docs/current/start/state/start.md)
